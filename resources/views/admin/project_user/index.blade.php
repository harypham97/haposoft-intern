...
@section('name_feature', 'Add user for projecte')
@section('content')
    <div class="container-fluid">
        <form id="formAddUserProject" action="{{route('project_user.store')}}">
            {{ csrf_field() }}
            ...
            <div class="form-group col-md-12">
                <label for="inputUser"> Choose user: <a id="showListCheckBox" href="#" class="text-decoration-none">List users (Click to see) >></a></label>
    ...
    <table class="table table-bordered table-hover" id="tableProjectUser">
        ...
        @foreach($data['data'] as $project)
            <tr>
                ...
                <td class=" d-flex">
                    <form id="formEdit">
                        <a class="btn btn-outline-primary btnEdit" href="{{route('project_user.edit',$project->id)}}" title="Edit">
